...
define('MAIN_DIR', realpath('/wordpress/'));
...
define('PERMISSIONS', 'newfile,newdir,editfile,deletefile,deletedir,renamefile,renamedir,uploadfile,terminal,movefile'); // empty means all
